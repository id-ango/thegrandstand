...
{
    public class ApDistribSetsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var dbakun = db.ApDistribSets.ToList();
        ...
        public ActionResult Details(int? id)
        {
            ...
            ApDistribSet arAkunSet = db.ApDistribSets.Find(id);
            if (arAkunSet == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "DistribID,AkunSet,GlAkunID1,GlAkunID2,GlAkunID3,GlAkunID4")] ApDistribSet arAkunSet)
        {
            if (ModelState.IsValid)
            {
                db.ApDistribSets.Add(arAkunSet);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DistribID,AkunSet,GlAkunID1,GlAkunID2,GlAkunID3,GlAkunID4")] ApDistribSet arAkunSet)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            ApDistribSet arAkunSet = db.ApDistribSets.Find(id);
            db.ApDistribSets.Remove(arAkunSet);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
