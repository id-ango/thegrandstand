...
namespace GlobalSoft.Controllers
{
    public class SetupTransController : Controller
    {
        ...
        {
            var aptTranss = db.AptTranss.Include(a => a.AptMarketing).Include(a => a.AptPayment).Include(a => a.AptTrsNo).Include(a => a.AptUnit).Include(a => a.ArCustomer);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TransNoID = new SelectList(db.AptTrsNo, "TransNoID", "TransNo");
        ...
        public ActionResult Create([Bind(Include = "TransID,NoRef,Tanggal,UnitID,CustomerID,MarketingID,Keterangan,Payment,PaymentID,TglSelesai,Cicilan,TransNoID")] AptTrans aptTrans)
        {
            ...
            ViewBag.TransNoID = new SelectList(db.AptTrsNo, "TransNoID", "TransNo", aptTrans.TransNoID);
